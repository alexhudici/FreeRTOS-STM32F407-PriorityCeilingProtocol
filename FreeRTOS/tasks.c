...
/*-----------------------------------------------------------*/
#if ( INCLUDE_uxTaskPriorityGet == 1 || configUSE_PCP == 1 )
...
TickType_t xTimeToWake;
	...
	#if ( INCLUDE_vTaskSuspend == 1 )
	{
		if( xTicksToWait == portMAX_DELAY )
		{
			...
			printf("\n%s task being placed on suspended task list", pxCurrentTCB->pcTaskName);
		}
		else
		{
...
#if ( configUSE_MUTEXES == 1 || configUSE_PCP)
...
/*-----------------------------------------------------------*/
	...
	void vTaskPCPPriorityDisinherit( TaskHandle_t const pxMutexHolder , UBaseType_t newPriority)
	{
	TCB_t * const pxTCB = ( TCB_t * ) pxMutexHolder;
